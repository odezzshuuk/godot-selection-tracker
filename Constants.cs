...
public static class Constants {
  ...
  public const string MAIN_WIN_SCENE_PATH = PLUGIN_DIR_PATH + "scenes/main-window.tscn";
  public const string MAIN_WIN_INSTANCE_PATH = SCENE_INSTANCE_DIR_PATH + "main-window.tscn";
